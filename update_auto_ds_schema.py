"""Script to update the auto_ds.py schema file."""
import os

content = '''"""Auto DS session and related schemas."""
...
with open(os.path.join(os.path.dirname(__file__), 'backend', 'app', 'schemas', 'auto_ds.py'), 'w') as f:
    f.write(content)
